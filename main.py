...
from SimilarityDecisionTreeClassifier import SimilarityDecisionTreeClassifier
...
def pipeline(dataset_i, depth=4):
    ...
    if data_info["task"] == "classification":
        ...
        Stree = SimilarityDecisionTreeClassifier(data_info["categorical"], max_depth=depth)
    else: 
    ...
    result = {
        ...
        "SIM_fitting_time": sim_fit_end_time-sim_fit_start_time,
        "SIM_prediction_time": sim_predict_end_time-sim_predict_start_time,
        "st_depth": st_depth,
        "st_nodes": st_nodes,
        "sim_depth": sim_depth,
        "sim_nodes": sim_nodes
    ...
    if data_info["task"] == "classification": 
        ...
        result["SIM_score"] = accuracy_score(y_test, sim_y_pred)
    else:
